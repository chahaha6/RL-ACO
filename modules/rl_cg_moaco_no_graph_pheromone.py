"""RL-CG-MOACO ablation without graph-aware pheromone reinforcement."""
...
class RLCGMOACO_NO_GRAPH_PHEROMONE(RLCGMOACO):
    """RL-CG-MOACO with uniform Pareto archive pheromone reinforcement."""
