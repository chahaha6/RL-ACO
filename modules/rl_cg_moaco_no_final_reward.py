"""RL-CG-MOACO ablation without Pareto-archive terminal reward."""
...
class RLCGMOACO_NO_FINAL_REWARD(RLCGMOACO):
    """RL-CG-MOACO trained only with scaled construction-step rewards."""
